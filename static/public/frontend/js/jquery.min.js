...
jQuery(document).ready(function(){
	...
	var baseUrl = 'https://www.floordi.com';
	
	
	if ($ .cookie("popup_1_2") == null) {
		$('.popup-banner').removeClass('hidden');
		$ .cookie("popup_1_2", "2");
	}
	...
	$('#main-body11').bind('cut copy paste', function (e) {
        e.preventDefault();
    });
	...
	$(".btn-search-mobile").click(function() {
		$.fancybox.open('<div id="timkiem"><form class="woocommerce-product-search" method="post" action="'+baseUrl+'/shop/search/"><input class="search-field" placeholder="Từ khóa sản phẩm..." value="" name="site_search" title="Từ khóa sản phẩm" type="search"><input value="Tìm kiếm" type="submit"></form></div>');
	});

	$("#tab-description").click(function() {
	    $('html, body').animate({
	        scrollTop: $("#content-description").offset().top - 120
	    }, 1000);
	});
	
	$("#tab-video").click(function() {
	    $('html, body').animate({
	        scrollTop: $("#content-video").offset().top - 120
	    }, 1000);
	});
	
	$(".tab-review").click(function() {
	    $('html, body').animate({
	        scrollTop: $("#content-review").offset().top - 120
	    }, 1000);
	});
	
	$("#tab-related").click(function() {
	    $('html, body').animate({
	        scrollTop: $("#content-related").offset().top - 120
	    }, 1000);
	});
	...
	$('.carousel-4').owlCarousel({
	    ...
	    dots: true,
	    navText: ["<a class=\"flex-prev\"></a>", "<a class=\"flex-next\"></a>"],
	    responsive:{0:{items:2},600:{items:4},1200:{items:4}}
	});
	...
	$('.carousel-5').owlCarousel({
	    ...
	    dots: true,
	    navText: ["<a class=\"flex-prev\"></a>", "<a class=\"flex-next\"></a>"],
	    responsive:{0:{items:2},600:{items:4},1200:{items:5}}
	});
	...
	$('#owl-carousel-blog').owlCarousel({
	    ...
	    dots: false,
	    navText: ["<a class=\"flex-prev\"></a>", "<a class=\"flex-next\"></a>"],
	    responsive:{0:{items:2},600:{items:3},1200:{items:4}}
	});
	
	$("div.toogle-slide").toggle(function(){
		$( ".category-desc" ).removeAttr( 'style' );
		$("div.toogle-slide").text('THU GỌN');
	  },function(){
		  $( ".category-desc" ).animate({height:135},200);
		  $("div.toogle-slide").text('XEM THÊM');
	  });
	...
	$('.product-rating').each(function () {
	    ...
	    $.post(baseUrl+"/shop/rate_product", { product_id:product_id,rating:rating},
			function(data){
				html = data.return_data;
				alert(html);
				//$("#product-rate-"+product_id).html(html);
			}, "json");
	    });
	...
	// Quantity Adder at Product page
	  $(".quantity-adder .add-action").click(function(){
	    if( $(this).hasClass('add-up') ) {  
	        $("[name=product_quantity]",'.quantity-adder').val( parseInt($("[name=product_quantity]",'.quantity-adder').val()) + 1 );
	    }else {
	      if( parseInt($("[name=product_quantity]",'.quantity-adder').val())  > 1 ) {
	        $("[name=product_quantity]",'.quantity-adder').val( parseInt($("[name=product_quantity]",'.quantity-adder').val()) - 1 );
	      }
	    }
	  });
